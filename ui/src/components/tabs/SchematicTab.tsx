...
import { ChevronRight, ArrowUp, ArrowDown, FileCode, Upload } from "lucide-react";
      ...
      <div className="flex shrink-0 items-center gap-3 border-b border-border bg-panel px-4 py-2 text-sm">
        <div className="flex items-center gap-1">
          <button
            ...
            className="flex items-center gap-1 rounded border border-border bg-bg px-2 py-1 text-fg disabled:opacity-40"
          >
          ...
          {descendableInstances.length > 0 ? (
            <label className="flex items-center" title="Descend into a subcircuit instance">
              ...
              <div className="relative">
                <select
                  className="appearance-none rounded border border-border bg-bg py-1 pl-7 pr-6 text-fg disabled:opacity-40"
                  value=""
                  disabled={loading}
                  onChange={(e) => {
            ...
            <button
              ...
              disabled
              className="flex items-center gap-1 rounded border border-border bg-bg px-2 py-1 text-fg opacity-40"
            >
        ...
        <button
          ...
          disabled={loading}
          className="flex items-center gap-1 rounded border border-border bg-bg px-2 py-1 text-xs text-fg disabled:opacity-40"
        >
