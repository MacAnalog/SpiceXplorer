        ...
        {candidates.length > 0 && (
          <div className="rounded-md border border-indigo-200 bg-indigo-50/60 p-3">
            ...
            <div className="flex flex-wrap gap-2">
              {candidates.map((c) => (
                <label key={c.name} className="flex items-center gap-1.5 rounded border border-indigo-200 bg-white px-2 py-1 text-xs">
                  <input
                    type="checkbox"
        ...
        {specs.map((s, i) => {
          ...
          return (
            <div key={i} className="rounded-md border border-zinc-200 bg-white">
              ...
              {isOpen && (
                <div className="grid grid-cols-[repeat(3,minmax(0,1fr))] gap-3 border-t border-zinc-100 p-3">
