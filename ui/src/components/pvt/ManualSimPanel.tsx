  ...
  return (
    <Panel>
      ...
      <PanelBody className="flex flex-col gap-3">
        ...
        {pdkMissing && (
          <div className="rounded border border-warn-soft bg-warn-soft px-2.5 py-1.5 text-[11px] text-[#b45309]">
        ...
        {mode === "manual" && dutParams.length > 0 && (
          <div className="max-h-[230px] overflow-auto rounded border border-border">
        ...
        {error && (
          <div
            role="alert"
            className="rounded border border-danger bg-danger-soft px-2.5 py-1.5 text-[11px] text-danger"
          >
            {error}
          </div>
        )}
        ...
        {result?.ok && (
          <div className="flex flex-col gap-2.5">
            ...
            {result.warnings.length > 0 && (
              <ul className="rounded border border-warn-soft bg-warn-soft px-2.5 py-1.5 text-[11px] text-[#b45309]">
                  ...
                  <div className="mt-1.5 flex flex-col gap-2">
                    {Object.entries(result.log_tails).map(([tb, tail]) => (
                      <div key={tb}>
                        ...
                        <pre className="max-h-[160px] overflow-auto rounded border border-border bg-hairline px-2 py-1 text-[10px] leading-snug text-fg">
                          {tail || "(empty)"}
                        </pre>
                      </div>
                    ))}
