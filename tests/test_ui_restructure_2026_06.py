...
# under pytest. Add it; the ui.* imports below importorskip on FastAPI/pydantic.
...
def test_apply_spec_overrides_ignores_unknown_spec_and_bad_goal():
    from ui.backend.services.score_service import apply_spec_overrides
...
def test_simulate_once_request_accepts_eng_string_params():
    from ui.backend.routes.simulate import SimulateOnceRequest
