...
def test_run_thread_filter_passes_only_its_thread():
    from ui.backend.services.optimizer_runner import _RunThreadFilter
...
def test_xschem_allowed_roots_include_work_root(tmp_path, monkeypatch):
    ...
    from ui.backend.routes import xschem
    from ui.backend.app_config import work_root
...
def test_build_dut_param_emits_val():
    from ui.backend.services.yaml_generator import _build_dut_param
...
def test_parse_to_form_carries_val():
    from ui.backend.services.yaml_generator import project_dict_to_form
...
def test_dut_param_val_full_round_trip():
    ...
    from ui.backend.services.yaml_generator import _build_dut_param, project_dict_to_form
